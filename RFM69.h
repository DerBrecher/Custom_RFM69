...
//#pragma message ( "SALVE_SELECT_PIN " DISPLAY_VALUE(SS))
//#pragma message ("RF69_IRQ_PIN = " DISPLAY_VALUE(RF69_IRQ_PIN))
...
class RFM69 {
  public:
	...
	virtual void sendWithoutIRQ(uint16_t toAddress, const void* buffer, uint8_t bufferSize, bool requestACK=false);
  ...
  protected:
	...
	virtual void sendFrameWithoutIRQ(uint16_t toAddress, const void* buffer, uint8_t size, bool requestACK=false, bool sendACK=false);
